...
<ul class="social">
    <?php if($facebookLink != ''): ?>
        <li>
            <a target="_blank" href="<?php echo $facebookLink; ?>"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="10" height="18" viewBox="0 0 10 18">
    ...
    <?php if($instagramLink != ''): ?>
        <li>
            <a target="_blank" href="<?php echo $instagramLink; ?>"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="18" height="18" viewBox="0 0 18 18">
    ...
    <?php if($youtubeLink != ''): ?>
        <li>
        <a target="_blank" href="<?php echo $youtubeLink; ?>"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="17" height="13" viewBox="0 0 17 13">
